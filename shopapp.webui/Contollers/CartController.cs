...
namespace shopapp.webui.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        {
            var userId = _userManager.GetUserId(User);
            var orders = _orderService.GetOrders((User.IsInRole("admin")) ? null : userId); 
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-vwod0VCtyzQ3xMPeRUMoi2yBeWv3ULH2";
            options.SecretKey = "sandbox-ntcioPEXaCwMPo0X3dJH2XEz4PUKsSPe";
